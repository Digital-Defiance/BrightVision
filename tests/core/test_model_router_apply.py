...
from bright_vision_core.model_router import ModelPoolEntry, ModelRouterConfig, RouteDecision
from bright_vision_core.model_router_apply import (
...
def test_apply_route_merges_hopper_extra_params():
    ...
    with patch("bright_vision_core.model_router_apply.models.Model", side_effect=_model_ctor):
